/*
  This code is based of of SDL2-2.0.4.
*/
/*
...
*/
/* Need this so Linux systems define fseek64o, ftell64o */
...
{
#ifdef HAVE_FSEEKO64
    if (fseeko64(context->hidden.stdio.fp, offset, whence) == 0) {
        return ftello64(context->hidden.stdio.fp);
    }
#elif defined(HAVE_FSEEKO)
    if (fseeko(context->hidden.stdio.fp, offset, whence) == 0) {
